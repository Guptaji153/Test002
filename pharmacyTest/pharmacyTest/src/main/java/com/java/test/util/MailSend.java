package com.java.test.util;import java.util.Properties;
...
public class MailSend {
	...
	public static String sendInfo(String toEmail, String subject, String data) {
		...
		// String from = "healthsure.pharmacies@gmail.com";
...
//            	 return new PasswordAuthentication("healthsure.pharmacies@gmail.com", "enwxyonsvcldiyuk");
