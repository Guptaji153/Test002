...
public void subtract(ActionEvent evt) {
	CalculationRemote statelessRemoteCalculator = null;
...
public void multiply(ActionEvent evt) {
	CalculationRemote statelessRemoteCalculator = null;
	
	try {
		statelessRemoteCalculator = lookupRemoteStatelessCalculator();
		this.result = statelessRemoteCalculator.mul(this.firstNo, this.secondNo);
	} catch (NamingException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
