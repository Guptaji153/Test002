...
import com.java.ejb.HelloBeanRemote;
...
public class Hello {
	...
	public void show(ActionEvent evt) {
		 HelloBeanRemote statelessRemoteHello = null;
		 try {
				statelessRemoteHello = lookupRemoteStatelessHello();
		        System.out.println("EJB Business Logic Getting Started");
		        this.result = statelessRemoteHello.sayHello();
	...
	private static Context createInitialContext() throws NamingException {
	   ...
	   private static HelloBeanRemote lookupRemoteStatelessHello() throws NamingException {
